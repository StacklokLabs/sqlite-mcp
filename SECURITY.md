...
["Report a Vulnerability"](https://github.com/StacklokLabs/sqlite-mcp/security/advisories/new)
tab.
...
- Create a new
  ...
  `https://github.com/StacklokLabs/sqlite-mcp/security/advisories/new`
