# Contributing to `sqlite-mcp` <!-- omit from toc -->

First off, thank you for taking the time to contribute to sqlite-mcp! :+1:
:tada: sqlite-mcp is released under the Apache 2.0 license. If you would like to
contribute something or want to hack on the code, this document should help you
get started. You can find some hints for starting development in sqlite-mcp's
[README](https://github.com/StacklokLabs/sqlite-mcp/blob/main/README.md).
...
[Contributor Covenant](https://github.com/StacklokLabs/sqlite-mcp/blob/main/CODE_OF_CONDUCT.md)
...
If you think you have found a security vulnerability in sqlite-mcp please DO NOT
...
[process](https://github.com/StacklokLabs/sqlite-mcp/blob/main/SECURITY.md)
...
["good first issue"](https://github.com/StacklokLabs/sqlite-mcp/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
- Fork the sqlite-mcp repository to your own GitHub account and clone it
  locally.
...
- Every pull request requires a review from the core sqlite-mcp team before
  merging.
